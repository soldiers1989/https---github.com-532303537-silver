...
public class GoodsRecordServiceImpl implements GoodsRecordService {
	...
	public Map<String, Object> merchantSendGoodsRecord(String merchantName, String merchantId, String customsPort,
		...
		// 验证前台传值
		Map<String, Object> reDataMap = checkData(jsonList, Integer.valueOf(customsPort), 1);
		...
		// 发起商品备案
		Map<String, Object> recordMap = sendRecord(Integer.valueOf(customsPort), merchantRecordInfo, tok, datas,
				goodsSerialNo, ciqOrgCode, customsCode);
	...
	public final Map<String, Object> getMerchantInfo(String merchantId, int eport) {
		...
		if (reList != null && reList.size() > 0) {
			...
			params.put(BaseCode.DATAS.toString(), merchantRecordInfo);
	 ...
	 * @return Map
	 */
	private final Map<String, Object> sendRecord(int eport, MerchantRecordInfo merchantRecordInfo, String tok,
	 ...
	 * @return Map
	 */
	private final Map<String, Object> createWarehous(String merchantId, String merchantName, String customsCode,
			String customsName) {
		Date date = new Date();
		Map<String, Object> statusMap = new HashMap<>();
	...
	public Map<String, Object> merchantBatchOrSingleGoodsRecord(String goodsRecordInfo, String merchantId,
		...
		for (int i = 0; i < jsonList.size(); i++) {
			...
			// 验证前台传值
			Map<String, Object> reDataMap = checkData(dataKeys, eport, 1);
			if (!"1".equals(reDataMap.get(BaseCode.STATUS.toString()) + "")) {
			...
			if (goodsInfo.getGoodsSerialNo() == null || "".equals(goodsInfo.getGoodsSerialNo())
				...
				// 发起商品备案
				Map<String, Object> recordMap = sendRecord(eport, merchantRecordInfo, tok, datas, newGoodsSerialNo,
				...
				List<Object> reList = goodsRecordDao.findByProperty(MerchantRecordInfo.class, paramMap, 0, 0);
	...
	public Map<String, Object> merchantEditGoodsRecordInfo(String managerId, String managerName, String[] str) {
		...
		if (reList != null && !reList.isEmpty()) {
			...
			for (int i = 0; i < str.length; i++) {
				...
				switch (i) {
				case 1:
					goodsRecordInfo.setEmsNo(value);
					break;
				case 2:
					goodsRecordInfo.setItemNo(value);
					break;
				case 3:
					goodsRecordInfo.setShelfGName(value);
					break;
				case 4:
					goodsRecordInfo.setNcadCode(value);
					break;
				case 5:
					goodsRecordInfo.setHsCode(value);
					break;
				case 6:
					goodsRecordInfo.setBarCode(value);
					break;
				case 7:
					goodsRecordInfo.setEmsNo(value);
					break;
				case 8:
					goodsRecordInfo.setGoodsName(value);
					break;
				case 9:
					goodsRecordInfo.setGoodsStyle(value);
					break;
				case 10:
					goodsRecordInfo.setgUnit(value);
					break;
				case 11:
					goodsRecordInfo.setStdUnit(value);
					break;
				case 12:
				...
				case 13:
					...
					break;
				case 14:
					goodsRecordInfo.setGiftFlag(value);
					break;
				case 15:
					goodsRecordInfo.setOriginCountry(value);
					break;
				case 16:
					goodsRecordInfo.setQuality(value);
					break;
				case 17:
					goodsRecordInfo.setQualityCertify(value);
					break;
				case 18:
				...
				case 20:
					...
					break;
				case 21:
					goodsRecordInfo.setNotes(value);
					break;
				case 22:
					goodsRecordInfo.setIngredient(value);
					break;
				case 23:
					goodsRecordInfo.setAdditiveflag(value);
					break;
				case 24:
					goodsRecordInfo.setPoisonflag(value);
					break;
				default:
					break;
				}
			...
			if (!goodsRecordDao.update(goodsRecordInfo)) {
				statusMap.put(BaseCode.STATUS.getBaseCode(), StatusCode.WARN.getStatus());
				statusMap.put(BaseCode.MSG.getBaseCode(), "修改商品信息错误,服务器繁忙!");
				return statusMap;
			}
			statusMap.put(BaseCode.STATUS.toString(), StatusCode.SUCCESS.getStatus());
			statusMap.put(BaseCode.MSG.toString(), StatusCode.SUCCESS.getMsg());
	...
	public Map<String, Object> batchCreateRecordGoodsDetail(GoodsRecordDetail goodsRecordDetail) {
		...
		if (!goodsRecordDao.add(goodsRecordDetail)) {
			statusMap.put(BaseCode.STATUS.toString(), StatusCode.NO_DATAS.getStatus());
			statusMap.put(BaseCode.MSG.toString(), "添加已备案商品详情失败!");
			return statusMap;
		}
		statusMap.put(BaseCode.STATUS.toString(), StatusCode.SUCCESS.getStatus());
		statusMap.put(BaseCode.MSG.toString(), StatusCode.SUCCESS.getMsg());
