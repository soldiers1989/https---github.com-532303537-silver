...
public interface GZEportService {
	 ...
	 * @return
	 */
	public  Map<String,Object> goodsRecord(String opType,String ieFlag,String businessType,Object records,String ebEntNo,String ebEntName,String currCode,String customsCode,String ciqOrgCode,String ebpentNo,String ebpentName);
	/**
	 * 商品备案
	 * @param list    商品信息list
	 * @param path    上传FTP路径
	 ...
	 * @throws IOException
	 */
	public  Map<String,Object> createHead(JSONArray list,String path,String opType,String businessType,String ieFlag,String ebEntNo,String ebEntName,String currCode,String customsCode,String ciqOrgCode,String ebpentNo,String ebpentName) throws FileNotFoundException, IOException;
	 ...
	 * @return
	 */
	public   Map<String,Object> orderRecord(Object records,String opType,String ieFlag,String internetDomainName,String ebpentNo,String ebpentName,String ebEntNo,String ebEntName,String customsCode,String ciqOrgCode );
