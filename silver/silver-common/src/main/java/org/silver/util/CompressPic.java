...
public class CompressPic {
	...
	public boolean compressPic(File file){
		try {
			if (!file.exists()) {
			...
			if (img.getWidth(null) == -1) {
				...
				String formatName = (outputDir
						+ outputFileName).substring((outputDir
	...
	public boolean compressPic(File f, String outputDir, String outputFileName, int width, int height,
			boolean gp) {
		// 输出图路径
		this.outputDir = outputDir;
		// 输入图文件名
