 ...
 *
 */
public class CheckPswMeterUtils {
    private String psw;
    ...
    public CheckPswMeterUtils(String psw){
    ...
    public static void main(String[] args) {
    	String str = "11232！1";
    	String regex = "^(?![A-Za-z]+$)(?!\\d+$)(?![\\W_]+$)\\S{6,20}$";    //密码的组成至少要包括大小写字母、数字及标点符号的其中两项
    	if(!str.matches(regex)){
    		System.out.println("----->>>密码至少要由包括大小写字母、数字、特殊符号符号的其中两项,共计6-18位编码组成！");
    	}else{
    		System.out.println("--===-===============");
    	}
